...
# Die vollständige Ligen- und Spieldatenbank
...
if game_input and spiel_auswahl != "Eigenes Spiel manuell eingeben...":
    ...
    # 8-Säulen-Logik für Torschnitte (Turniere vs. Liga)
